...
export default function AuditarCNPJ() {
    ...
    const [viewingHistoryCnpj, setViewingHistoryCnpj] = useState<string | null>(null);
                    ...
                    {!viewingHistoryCnpj ? (
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <Button variant="ghost" onClick={handleBackToHistory} className="gap-2">
                            ...
                            {isLoadingDetail ? (
                                <div className="flex items-center gap-3 p-6 border rounded-lg bg-card justify-center">
                                    ...
                                    <span className="font-medium text-muted-foreground">Carregando detalhes do histórico...</span>
                                </div>
                            ) : historyDetail ? (
                                <AuditResultView result={historyDetail} elapsed={"Visualização do Histórico"} />
                            ) : (
